...
const ContainerAzkar = () => {
  ...
  return (
   <Row style={{justifyContent:'space-evenly'}} className='ps-3 pe-3'>
    <Col lg={12} md={12} sm={12} xs={12} className='text-center text-white mt-5' style={{fontFamily: 'Reem Kufi , sans-serif',textShadow:'1px 2px #000000'}}><h1>«« {'الأذكار'}  »»</h1></Col>
    ...
    {des.slice(0,6).map((e,i)=>{
        ...
        <Col lg={12} md={12} sm={12} xs={12}  className='text-center text-white' style={{fontFamily: 'Reem Kufi , sans-serif',textShadow:'1px 2px #000000'}}><h1>«« {'الأدعية'}  »»</h1></Col>
    {des.slice(-2).map((e,i)=>{
        return (
            <Col key={i} lg={e.lg} md={e.lg}>
                  <AZCard title={e.title} id={e.id}/>
